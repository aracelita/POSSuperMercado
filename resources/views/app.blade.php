...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{ url('/') }}">Mi SuperMercado</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					@if (Auth::check())
						...
						<li><a href="{{ url('/Factura') }}">{{trans('menu.sales')}}</a></li>
						<li class="dropdown">
	...
	<footer class="footer hidden-print">
      <div class="container">
        <p class="text-muted">Usted esta usando <a href="http://github.com/qlint/L5-Pos">Mi SuperMercado</a> Extendido por<a href="http://github.com/qlint"> Aracely Cuyuch - Inga en Sistemas egresada de la Universidad Mariano Galvez</a>.
        </p>
      </div>
    </footer>
	<!-- Scripts -->
