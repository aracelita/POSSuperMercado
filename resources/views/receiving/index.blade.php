                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-9">
                        ...
                        <table class="table table-bordered">
                            <tr><th>{{trans('receiving.item_id')}}</th><th>{{trans('receiving.item_name')}}</th><th>Q{{trans('receiving.cost')}}</th><th>{{trans('receiving.quantity')}}</th><th>Q{{trans('receiving.total')}}</th><th>&nbsp;</th></tr>
